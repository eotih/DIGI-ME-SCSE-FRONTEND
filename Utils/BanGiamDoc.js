    ...
    const html = input.map(function (response) {
        ...
        <div class="text-lg-right text-center">
                    <div class="mr-5">
                        ...
                        <p>${Position}</p>
                        <p class="" style="text-align: justify; text-justify: inter-word; font-size:1rem;"> ${Details}</p>
                        <a href="https://www.facebook.com/nguyenquocgiang1308"><img src="../../images/image 18.png"></a>
                        <a href="http://zaloapp.com/qr/p/1smf36sqo8mao"><img src="../../images/image 17.png"></a>
                    </div>
                </div>
        `;
    })
